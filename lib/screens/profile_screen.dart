    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          Stack(
            children: [
              ...
              Positioned(
                ...
                top: -45,
                child: Container(
                  padding: EdgeInsets.symmetric(horizontal:AppLayout.getHeight(30),vertical:AppLayout.getHeight(30)),
                  decoration: BoxDecoration(
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      style: Styles.headLineStyle2.copyWith(
                        ...
                        color: Colors.white),),
                      Text("You have 95 flights this month",
                      style: Styles.headLineStyle2.copyWith(
                        fontWeight: FontWeight.w500,
          ...
          Text("Accumulated Miles",style: Styles.headLineStyle2.copyWith(color: Colors.black),),
          Gap(AppLayout.getHeight(20)),
          Container(
            ...
            child: Column(children: [
              ...
              Text("192802",style:TextStyle(color: Styles.textColor,fontSize: 40,fontWeight: FontWeight.w600)),
              Gap(AppLayout.getHeight(15)),
              Row(
              ...
              Gap(AppLayout.getHeight(12)),
              const AppLayoutBuliderWidget(sections: 12,isColor: false,),
              Gap(AppLayout.getHeight(12)),
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: const [
          ...
          Gap(AppLayout.getHeight(20)),
          InkWell(onTap: () => print("You are tapped"),child: 
          Center(child: Text("How to get more miles",
          style:Styles.textStyle.copyWith(
            color: Styles.primaryColor,
            fontWeight: FontWeight.w500),)))
        ],
